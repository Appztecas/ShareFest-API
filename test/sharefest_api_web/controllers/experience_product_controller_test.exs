  defmodule SharefestApiWeb.ExperienceProductControllerTest do
    ...
    @create_attrs %{description: "some description", name: "some name", price: 120.5, uri_image: "some uri_image"}
    @update_attrs %{description: "some updated description", name: "some updated name", price: 456.7, uri_image: "some updated uri_image"}
    ...
    describe "create experience_product" do
      test "renders experience_product when data is valid", %{conn: conn} do
        conn = post conn, experience_experience_product_path(conn, :create), experience_product: @create_attrs
      ...
      test "renders errors when data is invalid", %{conn: conn} do
        conn = post conn, experience_experience_product_path(conn, :create), experience_product: @invalid_attrs
    ...
    describe "update experience_product" do
      ...
      test "renders experience_product when data is valid", %{conn: conn, experience_product: %ExperienceProduct{id: id} = experience_product} do
        conn = put conn, experience_experience_product_path(conn, :update, experience_product), experience_product: @update_attrs
      ...
      test "renders errors when data is invalid", %{conn: conn, experience_product: experience_product} do
        conn = put conn, experience_experience_product_path(conn, :update, experience_product), experience_product: @invalid_attrs
        assert json_response(conn, 422)["errors"] != %{}
      end
    end
    ...
    describe "delete experience_product" do
      ...
      test "deletes chosen experience_product", %{conn: conn, experience_product: experience_product} do
